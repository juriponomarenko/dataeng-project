...
df = pd.read_json('/opt/airflow/dags/project/data/kym_spotlight.json')
df=df.T.reset_index()
...
df_final.to_json("/opt/airflow/dags/project/data/kym_spotlight_cleaned.json",orient='records')